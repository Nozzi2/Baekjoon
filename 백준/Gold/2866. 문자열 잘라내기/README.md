...
- 20:35 ~ 브레인 스토밍
    - 입력받으면서 StringBuilder로 문자열을 한개씩 만들어나가서 총 C개의 String을 만든다.
    - 문자1개를 subString을 이용해서 잘라준다.
    - 문자1개를 자른 C개의 String을 Set에 넣고, 다 넣고나면 Set의 크기와 R의 값을 비교해서 같다면 count++ 아니라면 종료한다.
- 21:00 ~ 코드 작성
- 21:35 풀이 완료! (1시간)
