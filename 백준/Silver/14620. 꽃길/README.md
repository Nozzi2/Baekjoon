...
### 풀이방법
 ...
 <p>2차원 배열을 한칸씩 조합으로 뽑는데, 해당칸과  상하좌우가 visited = false 인 칸이여야만 선택할 수 있다.</p>
 <p>3칸 모두 선택하면 합계를 구해서 min값이 저장하고 min에는 나온 조합 중에서 가장 작은 값을 저장한다.</p>
 <p></p>
