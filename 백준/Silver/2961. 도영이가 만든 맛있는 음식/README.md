...
- 22:45 ~ 브레인 스토밍
    - 부분집합을 구해서 부분집합 구한 부분집합에서 결과값을 구하면 될 것 같다.
- 22:55 ~ 코드 작성
    - 문제에서 입력이 1,000,000,000보다 작은 양의 정수라고 하였는데, 신맛은 맛들을 모두 곱해야 하므로 1,000,000,000 ^10 이 가장 최대값일 수 있다. 그래서 int가 아니라 long으로 선언해줬는데, 사실 long 범위도 벗어나긴한다.. ㅋ
- 23:20 풀이 완료! (35분)
